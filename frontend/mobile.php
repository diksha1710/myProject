        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <strong><font size="10px" color="pink">Mobiles Store</font></strong></div>
                     <hr style="background-color:green;width:100%;height:2px">
                    </div>
                <div id="t2" class="row-style"></div>
                <div id="t1" class="row-style">
                <?php
                include 'db.php';
                ...
                if(mysql_affected_rows()>0){
                    ...
                    while($r=mysql_fetch_assoc($result)){
                        ...
                        echo "<div class='row'>";
                        echo "<div class='col-sm-12 text-center img-box' style='padding-top:3px;background-color:steelgrey'><a href='mobile_desc.php?pid=$r[pid]'><img src='../$r[pimage]' height='230' width='150'/></a></div>";
                        echo "</div>";
                        echo "<br>";
