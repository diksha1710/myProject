...
if(isset($_POST['sign_up'])){
    ...
    $qry="insert into signup  values('$name','$email','$password','$gender','$dob',$phone,'$role')";
    mysql_query($qry);
        ...
        <div class="content-wrapper" style="padding-bottom:250px">
            <div class="container">
                ...
                <div class="col-md-12" style="padding-top:40px">
                    <h4 class="page-head-line" style="color:red">Add Users Here!!</h4>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Dob:</label>
                                <input type="text" name="txt_dob" class="form-control" />
                            </div>
                            ...
                            <div class="form-group">
                                <label>Role:</label>
                                <input type="text" name="txt_role" class="form-control" />
                            </div>
                            <div class="form-group">
