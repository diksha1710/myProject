                ...
                <div class='row'>
                    <div class='col-sm-12'>
                        ...
                        if(mysql_affected_rows()>0)
                        {
                            ...
                            echo "<tr>";
                            echo "<th>Name</th><th>Email ID</th><th>Phone No.</th><th>Country</th><th>Query</th><th></th><th></th><th></th><th></th>";
                        echo "</tr>";
                        while($r=mysql_fetch_array($result)){
                            ...
                            echo "<td>$r[4]></td>";
                            echo "<td><a href='deletequery.php?email=$r[1]'><input type='button' value='Delete' class='btn1'/></a></td>";
